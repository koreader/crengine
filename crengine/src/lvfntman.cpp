...
//    }
    ...
    void DrawStretchedGlyph(LVDrawBuf * buf, int glyph_index, int x, int y, int w, int h, lUInt32 * palette=NULL)
    {
        ...
        // and top/bottom side bearings. So, keep 1px on each side.
        int pad_top_bottom = 1;
...
#if (USE_BITMAP_FONTS==1)
bool LBitmapFont::getGlyphInfo( lUInt32 code, LVFont::glyph_info_t * glyph, lChar32 def_char, bool code_is_glyph_index=false, bool is_fallback )
{
