    ...
    switch (ch) {
        ...
        */
        ...
        case 0x007D: // }
            ratio  = 5;
            break;
        // CJK punctuation that should hang at end of line (closing/stop/comma types).
        // These are full-width glyphs whose ink is on one side; we hang 50% so
        // the blank half protrudes into the margin, matching traditional CJK typography.
        // Reference: the old floating punctuation code that explicitly handled these.
