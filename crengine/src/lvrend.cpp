...
bool is_length_relative_unit(css_value_type_t type)
{
    return (type == css_val_percent || type == css_val_em ||
            type == css_val_ex || type == css_val_rem ||
            type == css_val_vw || type == css_val_vh ||
            type == css_val_vmin || type == css_val_vmax);
}
