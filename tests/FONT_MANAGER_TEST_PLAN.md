...
| 2.3 | CSS4 intermediate weights 550 and 650 | **Not yet implemented** — the CSS parser rounds to the nearest 100, so 550 renders as 600 and 650 renders as 700 |
...
| 3.5 | CSS4 intermediate weight + italic (e.g. 550, italic) | **Not yet implemented** — weight rounds to nearest 100 before reaching the font manager |
